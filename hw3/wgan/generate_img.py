...
parser.add_argument('-load_path', default='model/model_epoch_498.pth', help='Checkpoint to load path from')
...
noise = torch.randn(int(args.num_output), 100, 1, 1, device=device)
...
plt.axis("off")
plt.title("Generated Images from WGAN")
